...
\ustcsetup{
<<<<<<< HEAD
  title              = {中国科学技术大学\\基于龙芯显卡的安卓图形栈的设计与实现 },
  title*             = {Design and implementation of an Android graphics system based on the Loongson platform },
  author             = {董哲},
  author*            = {Dong Zhe},
  speciality         = {计算机科学与技术},
  speciality*        = {Computer Science and Technology},
  supervisor         = {李诚教授, 徐成华高级工程师},
  supervisor*        = {Prof. Li Cheng, Prof. Xu Chenghua},
...
=======
  ...
  % secret-year          = {10},      % 保密/控阅期限
  % reviewer             = true,      % 声明页显示“评审专家签名”
>>>>>>> 5abd93b (Update the title page of professional degrees)
  %
  % 数学字体
