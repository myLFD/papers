...
\ustcsetup{
  title              = {基于龙芯显卡的安卓图形栈的\protect\\设计与实现},
  title*             = {Design and implementation of the Android Graphics Stack based on the Loongson GPU },
  author             = {董哲},
  author*            = {Dong Zhe},
  speciality         = {计算机技术},
  speciality*        = {Computer Technology},
  supervisor         = {李诚~副教授},
  supervisor*        = {Assoc. Prof. Li Cheng},
  practice-supervisor={徐成华~工程师},
  practice-supervisor*={Eng. Xu Chenghua},
  % date               = {2017-05-01},  % 默认为今日
  %professional-type  = {计算机技术},
  %professional-type* = {Computer Technology},
