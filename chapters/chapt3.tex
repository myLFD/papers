...
3.非功能需求
    ...
    % ​缓冲区分配延迟：单次gbm_bo_create调用耗时 ≤ 1ms（4K分辨率下）。
    % ​DMA-BUF导出吞吐量：支持 ≥ 60fps的1080p缓冲区导出速率。
...
\begin{figure}[h]
  \centering
  \includegraphics[width=0.8\textwidth]{gralloc调用栈v2.jpg}
  \caption{gralloc调用栈}
...
\begin{figure}[h]
  \centering
  \includegraphics[width=1\textwidth]{lgbm后端-1.jpg}
  \caption{lgbm后端-1}
  \label{fig:lgbm后端-1}
\end{figure}  
...
\begin{figure}[h]
  \centering
  \includegraphics[width=1\textwidth]{lgbm后端-2.jpg}
  \caption{lgbm后端-2}
  \label{fig:lgbm后端-2}
\end{figure}  
...
\begin{figure}[h]
  \centering
  \includegraphics[width=0.6\textwidth]{lgbm后端-3-1.jpg}
  \caption{lgbm后端-3-1}
...
\begin{figure}[h]
  \centering
  \includegraphics[width=1\textwidth]{lgbm后端-3-2.jpg}
  \caption{lgbm后端-3-2}
...
\begin{figure}[h]
  \centering
  \includegraphics[width=0.6\textwidth]{lgbm后端-4-1.jpg}
  \caption{lgbm后端-4-1}
...
\begin{figure}[h]
  \centering
  \includegraphics[width=0.4\textwidth]{lgbm后端-4-2.jpg}
  \caption{lgbm后端-4-2}
...
\begin{figure}[h]
  \centering
  \includegraphics[width=0.8\textwidth]{handle-buffer存储哈希表.jpg}
