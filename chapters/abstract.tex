...
\begin{abstract*}
  ...
  serving as the core component that coordinates performance and stability,
  ...
  based on the LoongArch architecture and Loongson GPU, this thesis covers the following work:
  ...
  To verify the correctness and usability of the system, this thesis conducts functionality tests on each module based on the official Android test suite.
