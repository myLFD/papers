...
在进行纹理资源创建时选择GSGPU\_SURF\_MODE\_TILED4或GSGPU\_SURF\_MODE\_TILED8，如\ref{lst:tile-choosing}，除光标等特殊图层外，其余纹理均使用Tile模式提高访存效率。
\lstset{
    language=C,
    basicstyle=\ttfamily\small,
    keywordstyle=\color{blue},
...
\begin{lstlisting}[caption={tile模式选择}, label={lst:tile-choosing}]
...
